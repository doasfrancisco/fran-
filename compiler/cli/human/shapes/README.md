...
| shape | fits |
|---|---|
| [rail](rail.md) | the detailed telling of a file with one run — a page, a script — or of a zoom on one block, written by claude |
| [sections](sections.md) | the detailed telling of a code file that is a set of functions: one head per block in story order, the inputs in the head |
